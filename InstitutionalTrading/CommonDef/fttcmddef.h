...
enum {
	...
	///注册前置机网络地址
	FTTCMD_ReqRegisterFront, 		//请求命令字
	FTTCMD_ReqRegisterFront_Rsp, 	//响应命令字
	...
	///请求查询交易编码
	FTTCMD_ReqQryTradingCode,
	FTTCMD_ReqQryTradingCode_Rsp,
...
enum {
	...
	///执行宣告录入错误回报
	FTTCMD_OnErrRtnExecOrderInsert,

	///执行宣告操作错误回报
	FTTCMD_OnErrRtnExecOrderAction,
