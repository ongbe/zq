...
alter table RISK_ORGIDPLANRELATION
  add constraint PK_RISK_ORGIDPLANRELATION primary key (ORGID, RISKINDICATORID);
...
;
insert into RISK_RISKINDICATOR (RISKINDICATORID, NAME, ALGORITHMDESC)
values (1, '合约最大持仓', '');
...
alter table RISK_RISKWARING
  add constraint PK_RISK_RISKWARING primary key (ORGID, RISKINDICATORID, RISKLEVELID);
...
prompt
prompt Creating table SIMU_CTP_TRADES
prompt ===============================
prompt
create table SIMU_CTP_TRADES
(
  brokerid           VARCHAR2(11),
  investorid         VARCHAR2(13),
  instrumentid       VARCHAR2(31),
...
;
comment on table SIMU_CTP_TRADES
  is '成交';
create index INDEX_SIMU_ORDERBROKER on SIMU_CTP_TRADES(BROKERID);
create index INDEX_SIMU_TRADEINVESTOR on SIMU_CTP_TRADES(INVESTORID);
create index INDEX_SIMU_TRADEVALIDATEDATE on SIMU_CTP_TRADES(VALIDATEDATE);


prompt
prompt Creating table SIMU_CTP_ORDERS
prompt ===============================
prompt
create table SIMU_CTP_ORDERS
(
  brokerid            VARCHAR2(11),
  investorid          VARCHAR2(13),
  instrumentid        VARCHAR2(31),
...
;
comment on table SIMU_CTP_ORDERS
  is '报单';
create index INDEX_SIMU_BROKER on SIMU_CTP_ORDERS(BROKERID);
create index INDEX_SIMU_INVESTOR on SIMU_CTP_ORDERS(INVESTORID);
create index INDEX_SIMU_VALIDATEDATE on SIMU_CTP_ORDERS(VALIDATEDATE);
