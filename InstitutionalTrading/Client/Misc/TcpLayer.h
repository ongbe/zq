...
#define WM_USER_Win              0x4111		//WM_USER+0x111的值，从WinUser.h中取出的，因为考虑clr中托管与非托管代码混用的方便，没有包含windows.h


//通知主线程窗口有数据到达的WM_USER_Win消息的wParam值
#define WndUserCmd_DataArrival 0x3bbb
//通知主线程窗口连接状态发生变化的WM_USER_Win消息的wParam值。lParam==0/1/2/3分别表示连接断开/连接开始/连接成功/连接失败
#define WndUserCmd_ConnStatus  0x3bbc
