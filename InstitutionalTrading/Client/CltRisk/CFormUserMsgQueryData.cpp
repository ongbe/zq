...
bool CltRisk::CFormUserMsgQueryData::NewQuery(int nUserID, std::string& strDate, bool bIsSend)
{
...
void CltRisk::CFormUserMsgQueryData::ResetQuery_Send()
{
	LockObject();
...
void CltRisk::CFormUserMsgQueryData::ResetQuery_Recv()
{
	LockObject();
