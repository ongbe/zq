...
bool CltServerMgr::FormQueryHistoryFundData::NewQuery(std::string& strStartDate, 
...
bool CltServerMgr::FormQueryHistoryFundData::NextQuery()
{
	...
	CTcpLayer::SendData(Cmd_RM_QryHistoryFundInfo_Req, (void*)pBuff, nDataLen, 0, nUserID);
	delete pBuff;
	
	return true;
}

bool CltServerMgr::FormQueryHistoryFundData::StopQuery()
{
	while(!queueDate.empty()) 
		queueDate.pop();
	return true;
...
void CltServerMgr::FormQueryHistoryFundData::ResetQuery()
{
	LockObject();
	//mapKey2Index.clear();
	//mapIndex2Key.clear();
...
//void CltServerMgr::FormQueryHistoryFundData::CheckNewData(CDataInfo* pdataInfo, 
