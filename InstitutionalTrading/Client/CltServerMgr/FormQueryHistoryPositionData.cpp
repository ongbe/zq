...
bool CltServerMgr::FormQueryHistoryPositionData::NewQuery(std::string& strStartDate, 
...
bool CltServerMgr::FormQueryHistoryPositionData::NextQuery()
{
	...
	CTcpLayer::SendData(Cmd_RM_QryHistoryPosition_Req, (void*)pBuff, nDataLen, 0, nUserID);
	delete pBuff;
	
	return true;
}

bool CltServerMgr::FormQueryHistoryPositionData::StopQuery()
{
	while(!queueDate.empty()) 
		queueDate.pop();
	return true;
...
void CltServerMgr::FormQueryHistoryPositionData::ResetQuery()
{
	LockObject();
	//mapKey2Index.clear();
	//mapIndex2Key.clear();
...
//void CltServerMgr::FormQueryHistoryPositionData::CheckNewData(CDataInfo* pdataInfo, 
