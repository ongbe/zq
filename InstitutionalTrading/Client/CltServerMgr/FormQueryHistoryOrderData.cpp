...
bool CltServerMgr::FormQueryHistoryOrderData::NewQuery(std::string& strStartDate, 
...
bool CltServerMgr::FormQueryHistoryOrderData::NextQuery()
{
	...
	CTcpLayer::SendData(Cmd_RM_QryHistoryOrders_Req, (void*)pBuff, nDataLen, 0, nUserID);
	delete pBuff;
	
	return true;
}

bool CltServerMgr::FormQueryHistoryOrderData::StopQuery()
{
	while(!queueDate.empty()) 
		queueDate.pop();
	return true;
...
void CltServerMgr::FormQueryHistoryOrderData::ResetQuery()
{
	LockObject();
	//mapKey2Index.clear();
	//mapIndex2Key.clear();
...
//void CltServerMgr::FormQueryHistoryOrderData::CheckNewData(CDataInfo* pdataInfo, 
