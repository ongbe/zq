...
bool CltServerMgr::FormQueryHistoryTradeData::NewQuery(std::string& strStartDate, 
...
bool CltServerMgr::FormQueryHistoryTradeData::NextQuery()
{
	...
	CTcpLayer::SendData(Cmd_RM_QryHistoryTrade_Req, (void*)pBuff, nDataLen, 0, nUserID);
	delete pBuff;
	
	return true;
}

bool CltServerMgr::FormQueryHistoryTradeData::StopQuery()
{
	while(!queueDate.empty()) 
		queueDate.pop();
	return true;
...
void CltServerMgr::FormQueryHistoryTradeData::ResetQuery()
{
	LockObject();
	//mapKey2Index.clear();
	//mapIndex2Key.clear();
...
//void CltServerMgr::FormQueryHistoryTradeData::CheckNewData(CDataInfo* pdataInfo, 
