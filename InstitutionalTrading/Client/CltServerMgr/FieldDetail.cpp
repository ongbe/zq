...
///买卖方向
const char* CltServerMgr::CFieldDetail::Direction2String(char param)
{
...
///开平标志
const char* CltServerMgr::CFieldDetail::OffsetFlag2String(char param)
{
...
///报单状态
const char* CltServerMgr::CFieldDetail::OrderStatus2String(char param)
{
	...
	switch(param)
	{
        ...
        //case THOST_FTDC_OST_ERROE:				    return Error;
		default: return __UNKOWN__;
	}
}

///报单提交状态
const char* CltServerMgr::CFieldDetail::OrderSubmitStatus2String(char param)
{
...
///报单价格条件
const char* CltServerMgr::CFieldDetail::OrderPriceType2String(char param)
{
...
///投机套保标志
const char* CltServerMgr::CFieldDetail::HedgeFlag2String(char param)
{
...
///持仓多空方向
const char* CltServerMgr::CFieldDetail::PosiDirection2String(char param)
{
...
///强平原因
const char* CltServerMgr::CFieldDetail::ForceCloseReason2String(char param)
{
	...
	switch(param)
	{
		...
		case THOST_FTDC_FCC_ClientOverPositionLimit:	return ClientOverPositionLimit;
...
///报单类型
const char* CltServerMgr::CFieldDetail::OrderType2String(char param)
{
...
///有效期类型
const char* CltServerMgr::CFieldDetail::TimeCondition2String(char param)
{
...
///成交量类型
const char* CltServerMgr::CFieldDetail::VolumeCondition2String(char param)
{
...
///业务请求函数返回结果
const char* CltServerMgr::CFieldDetail::ReturnCode2String(int param)
{
...
///品种类型
const char* CltServerMgr::CFieldDetail::ProductType2String(char param)
{
...
const char* CltServerMgr::CFieldDetail::UserForceClose2String(int UserForceClose)
{
...
///成交类型
const char* CltServerMgr::CFieldDetail::TradeType2String(char TradeType)
{
...
//交易角色
const char* CltServerMgr::CFieldDetail::TraderRole2String(int param)
{
...
//成交来源
const char* CltServerMgr::CFieldDetail::TradeSourceString(int param)
{
...
//成交价来源
const char* CltServerMgr::CFieldDetail::PriceType2String(int param)
{
