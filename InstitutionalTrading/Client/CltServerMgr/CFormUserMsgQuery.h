...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridRecv->Location = System::Drawing::Point(518, 58);
			...
			this->dataGridSend->Location = System::Drawing::Point(9, 58);
			...
			this->dataGridSend->TabIndex = 31;
			// 
			// buttonClearRecv
			// 
			this->buttonClearRecv->Location = System::Drawing::Point(652, 31);
			this->buttonClearRecv->Name = L"buttonClearRecv";
			this->buttonClearRecv->Size = System::Drawing::Size(45, 23);
			this->buttonClearRecv->TabIndex = 30;
			...
			this->dtpStart->Location = System::Drawing::Point(56, 4);
			...
			this->ClientSize = System::Drawing::Size(899, 527);
...
#pragma endregion
	...
	void ShowQueue_Send(std::queue<UserMsgStru>& queueRet) {
		...
		CDataInfo* pDataInfo = CDataInfo::NewInstance();
		...
		while(!queueRet.empty()) {
			...
			if(pDataInfo!=NULL) {
				if(pDataInfo->GetUserInfoByUserID(field.TargetUserID, sUserInfo))
	...
	void ShowQueue_Recv(std::queue<UserMsgStru>& queueRet) {
		...
		while(!queueRet.empty()) {
			...
			if(nIndex>=0) {
				memset(strTemp, 0, sizeof(strTemp));
				if(pDataInfo!=NULL) {
					if(pDataInfo->GetUserInfoByUserID(field.OwnerUserID, sUserInfo)) {
						sprintf_s(strTemp, sizeof(strTemp)-1, "%s", sUserInfo.szAccount);
						strMe = strTemp;
					}
				}
	...
	private: System::Void buttonQuerySend_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 m_pdataInfo->GetLogonInfo(logInfo);
