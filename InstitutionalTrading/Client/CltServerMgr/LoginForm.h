...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
            ...
            this->checkBox1->Location = System::Drawing::Point(90, 81);
			...
			case CMDID_Login_Rsp:
				{
					...
					{	
						...
						CTcpLayer::SendData(Cmd_QueryOrg_Req, NULL,0, 0, loginReq.mnUserID);//组织机构               
					}
					else
					{
						bShowMsg = true;
						strError = p+sizeof(Stru_UniPkgHead);
					}
				}
				break;
			...
			case Cmd_QueryOrg_Rsp:
				{
					...
					if ( head.userdata1 == CF_ERROR_SUCCESS )
					{
						...
						CTcpLayer::SendData(Cmd_QryUser_Req, NULL,0, 0, loginRsp.mnUserID);
					}
					else
					{
			...
			case Cmd_QryUser_Rsp:
				{           
					...
					if ( head.userdata1 == CF_ERROR_SUCCESS )
					{
						...
						sLoginRsp loginRsp = {0};
						CDataInfo::NewInstance()->GetLogonInfo(loginRsp);
						CTcpLayer::SendData(Cmd_QryUserOrgRelation_Req, NULL,0, 0, loginRsp.mnUserID);
					}
					else
					{
