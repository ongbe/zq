...
namespace CFMap.MapProviders
{
   ...
   using System.Threading;
    ...
    using System.Xml;
   public abstract class BingMapProviderBase : IMapProvider
   {
               ...
               if(!string.IsNullOrEmpty(html))
               {
                  ...
                  if(mat.Success)
                  {
                     ...
                     if(count > 2)
                     {
                        ...
                        string old = CCFMapProviders.BingMap.Version;
                        if(ver != old)
                        {
                            CCFMapProviders.BingMap.Version = ver;
                            CCFMapProviders.BingSatelliteMap.Version = ver;
                         //   CCFMapProviders.BingHybridMap.Version = ver;
#if DEBUG
