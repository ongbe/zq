...
namespace CFMap.CoreType.Internals
{
   ...
   internal class CacheLocator
   {
      ...
      static void Reset()
      {
         ...
         //location = System.Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData) + Path.DirectorySeparatorChar + "CFMap" + Path.DirectorySeparatorChar;

         location = System.Environment.CurrentDirectory + Path.DirectorySeparatorChar;
         // http://greatmaps.codeplex.com/discussions/403151
         if(string.IsNullOrEmpty(location)) 
         {
            CFMaps.Instance.Mode = AccessMode.ServerOnly;
            CFMaps.Instance.UseDirectionsCache = false;
            CFMaps.Instance.UseGeocoderCache = false;
            CFMaps.Instance.UsePlacemarkCache = false;
            CFMaps.Instance.UseRouteCache = false;
            CFMaps.Instance.UseUrlCache = false;
         }
   ...
   internal class Cache : Singleton<Cache>
   {
      ...
      public Cache()
      {
...

         {
            ...
            string oldCache = System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData) + Path.DirectorySeparatorChar + "CFMap" + Path.DirectorySeparatorChar;
