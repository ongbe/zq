...
public:
	...
	static CTcpDataConnect* CreateConnect(string& SvrIP, WORD SvrPort, CTcpConnectSpi* pApi);
...
public:
	CTcpDataConnect(string& SvrIP, WORD SvrPort, CTcpConnectSpi* pApi);
	~CTcpDataConnect();
	...
	CTcpConnectSpi* GetConnectSpi() {
		return m_pConnectSpi;
	};
...
private:
	...
	static map<SOCKET, CTcpConnectSpi*>		m_mapSpi;
