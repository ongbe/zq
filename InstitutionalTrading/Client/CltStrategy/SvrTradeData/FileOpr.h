...
private:
    ...
    //bDaily: 是否每天一个日志文件
	bool writelocallog_internal(const char* subpathname,const char* logname,const char* logbuf,bool bDaily,bool bEncrypt=false,bool bAppendExtName=true,bool bInsertTime=true,bool bDelFileFirst=false);
