...
public:
    ...
    void Clear();
    void GetTradeDay(TThostFtdcDateType szTradeDay);
    ...
    //获得CThostFtdcMdApi接口
    inline CThostFtdcMdApi* GetCThostFtdcMdApi(){return m_pQuotApi;};
    //这里保存每个合约的最新行情
    bool GetLastQuotMap(map<string,CThostFtdcDepthMarketDataField>& mapLastQuot );	
...
private:
    ...
    TThostFtdcDateType m_TradeDay;      //登录成功后返回的交易日
};
