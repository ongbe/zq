    ...
    public class IOrderServiceEx : IOrderService
    {
        ...
        public override bool GetPositions(QryPosition qry, ref List<PositionInfo> refPositions)
        {
            ...
            lock (this)
            {
                ...
                string msg = "请求查询交易员持仓"+ szHashId + szInst;
                Log.Out(msg);
            ...
            foreach (PositionInfo info in refPositions)
            {
                string szInfo = info.InvestorID + info.InstrumentID + info.Position.ToString() + info.TodayPosition.ToString() + info.YdPosition.ToString();
                Log.Out(szInfo);
            }            
        ...
        // 请求查询交易员持仓明细
        public override bool GetPositionDetails(QryPositionDetail qry, ref List<PositionDetailInfo> retPositionDetails)
        {
            return true;
        }
