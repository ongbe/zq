...
bool operator==(const CShfeFtdcInvestorHashField &ct) const
{
	bool ret = true;
...
bool operator==(const CShfeFtdcQryInvestorMarginRateField &ct) const
{
	bool ret = true;
	ret = ret && (strcmp(BrokerID, ct.BrokerID) == 0);
	if (!ret) return ret;
...
bool operator==(const CShfeFtdcInvestorMarginRateField &ct) const
{
	bool ret = true;
	ret = ret && (strcmp(InstrumentID, ct.InstrumentID) == 0);
	if (!ret) return ret;
...
bool operator==(const CShfeFtdcSTPriceField &ct) const
{
	bool ret = true;
	ret = ret && (strcmp(BrokerID, ct.BrokerID) == 0);
	if (!ret) return ret;
...
bool operator==(const CShfeFtdcSTMarginRateField &ct) const
{
	bool ret = true;
	ret = ret && (strcmp(InstrumentID, ct.InstrumentID) == 0);
	if (!ret) return ret;
