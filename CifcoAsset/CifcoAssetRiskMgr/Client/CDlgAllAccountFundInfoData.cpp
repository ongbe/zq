...
bool Client::CDlgAllAccountFundInfoData::NewQuery()
{
#if 1
	int nReqID = 0;
	int nIndex = 0;
...
void Client::CDlgAllAccountFundInfoData::ResetQuery()
{
	 LockObject();
	 mapKey2Index.clear();
	 mapIndex2Key.clear();
...
void Client::CDlgAllAccountFundInfoData::CheckNewData(CDataInfo* pdataInfo, 
