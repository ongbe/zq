			...
			case Cmd_RM_SubscribeTrade_Rsp:
			{
				...
				if(head.userdata1 == OPERATOR_SUCCESS) {
					...
					if(head.userdata2 == head.userdata3 - 1) {
						...
						{
							char csText[1024] = {0};
							sprintf(csText, "实时成交查询，本次查询时间消耗 传输==%u, 显示==%u",
