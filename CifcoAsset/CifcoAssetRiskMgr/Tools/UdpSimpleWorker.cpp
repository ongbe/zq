...
*******************************************************************************************************/
void CUdpSimpleWorker::GetSocketSet_Internal(fd_set& ReadSocketSet,fd_set& WriteSocketSet,fd_set& ExceptSocketSet)
{
...
//   @brief		处理socket的意外事件
//**************************************************
void CUdpSimpleWorker::CheckSocketExcept_Internal(fd_set& ExceptSocketSet)
{
	int i;
	SOCKET hSocket;
...
//   @brief		处理Read
//**************************************************
void CUdpSimpleWorker::TryRead_Internal(fd_set& ReadSocketSet)
{
