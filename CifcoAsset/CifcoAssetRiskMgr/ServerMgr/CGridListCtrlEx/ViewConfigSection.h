...
//------------------------------------------------------------------------
class AFX_EXT_CLASS CViewConfigSection
{
protected:
...
//------------------------------------------------------------------------
class AFX_EXT_CLASS CViewConfigSectionDefault : public CViewConfigSection
{
protected:
...
//------------------------------------------------------------------------
class AFX_EXT_CLASS CViewConfigSectionProfiles : public CViewConfigSectionDefault
{
protected:
...
//------------------------------------------------------------------------
class AFX_EXT_CLASS CViewConfigSectionWinApp : public CViewConfigSectionProfiles
{
protected:
