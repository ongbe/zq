...
PlatformStru_PositionCombDetail PlatformStru_PositionCombDetail::InvalidPositionDetailComb(true);
...
int CPlatformDataMgr::GetPositionCombInfo(long lFTID, PlatformStru_PositionCombDetail& outData)
{
	ASSERT("The method is not implemented in pats.");
	return 0;
}
