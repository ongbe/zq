...
BOOL CMovePositionServiceThread::MakeReq(wxString& strInstrumentID, BOOL bDirection, int nOCMode, 
										 double fPrice, int nVolume, int nHedgeStatus, BOOL bIsMarketPrice, 
...
//	LoadDataFromFile();
	...
	if(DEFAULT_SVR()) DEFAULT_SVR()->SubscribeBusinessData(BID_ErrRtnOrderInsert, GID_MOVESWAPPOSITION_SERVICETHREAD, CMovePositionServiceThread::RspOrderInsertCallBackFunc);
	...
	if(DEFAULT_SVR()) DEFAULT_SVR()->SubscribeBusinessData(BID_RspOrderAction, GID_MOVESWAPPOSITION_SERVICETHREAD, CMovePositionServiceThread::RspOrderInsertCallBackFunc);
	if(DEFAULT_SVR()) DEFAULT_SVR()->SubscribeBusinessData(BID_ErrRtnOrderAction, GID_MOVESWAPPOSITION_SERVICETHREAD, CMovePositionServiceThread::RspOrderInsertCallBackFunc);
	return TRUE;
...
//									((wxEvtHandler*)tMove.pWnd)->AddPendingEvent(evt);
	                                if(1)
	                                {
		                                ...
		                                if(CFTEventParam::CreateEventParam(EvtParamID,NULL,&EvtParamStr,(char*)&RawData,sizeof(DataRtnOrder),0))
		                                {
...
//									((wxEvtHandler*)tMove.pWnd)->AddPendingEvent(evt);
	                                if(1)
	                                {
		                                DWORD EvtParamID;
		                                std::string EvtParamStr(strText.c_str());
		                                if(CFTEventParam::CreateEventParam(EvtParamID,NULL,&EvtParamStr,&RawData,sizeof(DataRtnOrder),0))
		                                {
			                                evt.SetInt((int)EvtParamID);
			                                ((wxEvtHandler*)tMove.pWnd)->AddPendingEvent(evt);
		                                }
...
//									((wxEvtHandler*)tMove.pWnd)->AddPendingEvent(evt);
	                                if(1)
	                                {
		                                DWORD EvtParamID;
		                                std::string EvtParamStr(strText.c_str());
		                                if(CFTEventParam::CreateEventParam(EvtParamID,NULL,&EvtParamStr,&RawData,sizeof(DataRtnOrder),1))
		                                {
			                                evt.SetInt((int)EvtParamID);
			                                ((wxEvtHandler*)tMove.pWnd)->AddPendingEvent(evt);
		                                }
...
//									((wxEvtHandler*)tMove.pWnd)->AddPendingEvent(evt);
		...
		case BID_RspOrderAction:
		{
			...
			//	break;
			//DataRspOrderAction& RawData= *(DataRspOrderAction*)(pAbstractBusinessData);
