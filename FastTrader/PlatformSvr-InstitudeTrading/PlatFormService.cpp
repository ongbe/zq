...
int CPlatFormService::ReqUserPasswordUpdate(PlatformStru_UserPasswordUpdate *pUserPasswordUpdate, int nRequestID)
{
    ...
    strncpy(pUserPasswordUpdate->BrokerID, m_PlatformParam.BrokerID.c_str(), sizeof(pUserPasswordUpdate->BrokerID)-1); ///经纪公司代码       
    strncpy(pUserPasswordUpdate->UserID, m_PlatformParam.UserID.c_str(), sizeof(pUserPasswordUpdate->UserID)-1);  ///用户代码,等于投资者代码
...
int CPlatFormService::ReqTradingAccountPasswordUpdate(PlatformStru_TradingAccountPasswordUpdate *pTradingAccountPasswordUpdate, int nRequestID)
{
    ...
    strncpy(pTradingAccountPasswordUpdate->BrokerID, m_PlatformParam.BrokerID.c_str(), sizeof(pTradingAccountPasswordUpdate->BrokerID)-1); ///经纪公司代码       
    strncpy(pTradingAccountPasswordUpdate->AccountID, m_PlatformParam.UserID.c_str(), sizeof(pTradingAccountPasswordUpdate->AccountID)-1);  ///资金账号,等于用户代码,也等于投资者代码
