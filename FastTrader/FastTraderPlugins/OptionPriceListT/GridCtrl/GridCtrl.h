...
public:
    ...
    void SetShowFocusRect(BOOL bTrack)            { m_bShowFocusRect = bTrack;        }
    BOOL GetShowFocusRect()                       { return m_bShowFocusRect;          }
...
public:
	...
	BOOL SortNumericItems(int nCol, BOOL bAscending, LPARAM data = 0);
...
public:
	class CLockObject {
	public:
		CLockObject(LPCRITICAL_SECTION pCS) {
			m_pCS = pCS;
