...
class __declspec(dllexport)  CTextFileBase
{
public:
...
class __declspec(dllexport)  CTextFileWrite : public CTextFileBase
{
...
class __declspec(dllexport)  CTextFileRead : public CTextFileBase
{
