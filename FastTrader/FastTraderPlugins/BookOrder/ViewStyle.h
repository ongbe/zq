...
typedef struct {
	...
	CELLCOLOR tFixedEvenRow;	// 固定行偶数行
...
// PriceGrid颜色结构体
typedef struct {
	//ROWCOLOR	tTradeBuyCol;	// 申买挂单数列的行颜色配置
	//ROWCOLOR	tConditionBuyCol;	// 申买挂单数列的行颜色配置
	...
	//ROWCOLOR	tConditionSellCol;	// 申卖挂单数列的行颜色配置
	//ROWCOLOR	tTradeSellCol;	// 申卖挂单数列的行颜色配置
	ROWCOLOR	tOtherCol;	// 申卖挂单数列的行颜色配置
