...
//Uncomment the following 2 lines to enable support for CBKMenu class
...
class CBKButton : public CButton
{
public:
    CBKButton();
	~CBKButton();
...
#ifdef	BTNST_USE_BCMENU
	CBKMenu		m_menuPopup;		// CBKMenu class instance
#else
