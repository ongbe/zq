...
{
    m_dVolatilityTest = dVolatilityTest;
}
...
void    CDataInfo::Calculate()
{
    ...
    m_PLProbability = new CPLProbability(m_InstrumentDepthData.LastPrice, m_dVolatility, RemainDays);
...
void CDataInfo::SetAccount(string sAccount)
{
    m_szAccount = sAccount;
}

void CDataInfo::SetTradingDay(string sDay)
{
    m_TradingDay = sDay;
}

void CDataInfo::InsertMapExchangeID2ProductID(const string& sExchangeID, const set<string>& setProductID)
{
    m_mapExchangeID2ProductID.insert(make_pair(sExchangeID,setProductID));
}

void CDataInfo::SetProductId2InstID(const string& sProductID, const set<string>& setInstID)
{
    m_mapProductID2InstID.insert(make_pair((string)sProductID,setInstID));
}

void CDataInfo::ClearRelaInstrumentInfo(void)
{
    m_setRelaInstrumentInfoReq.clear();
    m_vecRelaInstrumentInfoReq.clear();
}

void CDataInfo::SetSubscribeInstrument(const string& sInstID)
{
    m_SubscribedInstrument=sInstID;
}

void CDataInfo::InsertSetRelaInstrumentInfo(const string& sInstID)
{
    m_setRelaInstrumentInfoReq.insert(sInstID);
}

string CDataInfo::GetSubscribedInstrument(void)
{
    return m_SubscribedInstrument;
}

void CDataInfo::GetVecRelaInstrumentInfoReq(vector<PlatformStru_InstrumentInfo>& vecRelaInstrumetInfoReq)
{
    vecRelaInstrumetInfoReq = m_vecRelaInstrumentInfoReq;
}

void CDataInfo::GetSetRelaInstrumentInfoReq(set<string>& setRelaInstrumetInfoReq)
{
    setRelaInstrumetInfoReq = m_setRelaInstrumentInfoReq;
}
