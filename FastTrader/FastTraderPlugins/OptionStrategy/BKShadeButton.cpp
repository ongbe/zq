// CBKShadeButton.cpp : implementation file
#include "stdafx.h"
#include "BKShadeButton.h"
...
/////////////////////////////////////////////////////////////////////
bool CBKDib::IsWin30Dib(){
	return ((*(LPDWORD)(hDib))==sizeof(BITMAPINFOHEADER));
}
/////////////////////////////////////////////////////////////////////
WORD CBKDib::GetPaletteSize()
{
//    if (IsWin30Dib())
...
/////////////////////////////////////////////////////////////////////
HDIB  CBKDib::Create(DWORD dwWidth, DWORD dwHeight, WORD wBitCount)
{
...
/////////////////////////////////////////////////////////////////////
long CBKDib::Draw(HDC pDC, long xoffset, long yoffset)
{
	if((hDib)&&(pDC))  {
...
/////////////////////////////////////////////////////////////////////
long CBKDib::Stretch(HDC pDC, long xoffset, long yoffset, long xsize, long ysize)
{
	if((hDib)&&(pDC)) {
		//palette must be correctly filled
		LPSTR lpDIB = (char*)hDib;	//set image to hdc...
...
/////////////////////////////////////////////////////////////////////
void CBKDib::SetPaletteIndex(BYTE idx, BYTE r, BYTE g, BYTE b)
{
	if ((hDib)&&(m_nColors)){
...
/////////////////////////////////////////////////////////////////////
void CBKDib::SetPaletteIndex(BYTE idx, RGBQUAD c)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
void CBKDib::SetPaletteIndex(BYTE idx, COLORREF cr)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CBKDib::GetPaletteIndex(BYTE idx)
{
	RGBQUAD rgb = {0,0,0,0};
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
...
/////////////////////////////////////////////////////////////////////
BYTE CBKDib::GetPixelIndex(long x,long y)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CBKDib::GetPixelColor(long x,long y)
{
	RGBQUAD rgb={0,0,0,0};
...
/////////////////////////////////////////////////////////////////////
void CBKDib::SetPixelIndex(long x,long y,BYTE i)
{
	if ((hDib==NULL)||(m_nColors==0)||
...
/////////////////////////////////////////////////////////////////////
void CBKDib::SetPixelColor(long x,long y,COLORREF cr)
{
	SetPixelColor(x,y,RGB2RGBQUAD(cr));
	return;
}
/////////////////////////////////////////////////////////////////////
void CBKDib::SetPixelColor(long x,long y,RGBQUAD c)
{
	if ((hDib==NULL)||(x<0)||(y<0)||
...
/////////////////////////////////////////////////////////////////////
BYTE CBKDib::GetNearestIndex(RGBQUAD c)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CBKDib::RGBtoHSL(RGBQUAD lRGBColor)
{
...
/////////////////////////////////////////////////////////////////////
WORD CBKDib::HueToRGB(WORD n1,WORD n2,WORD hue)
{ 
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CBKDib::HSLtoRGB(COLORREF cHSLColor)
{
	return HSLtoRGB(RGB2RGBQUAD(cHSLColor));
}
/////////////////////////////////////////////////////////////////////
RGBQUAD CBKDib::HSLtoRGB(RGBQUAD lHSLColor)
{ 
	WORD hue,lum,sat;
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CBKDib::RGB2RGBQUAD(COLORREF cr)
{
	RGBQUAD c;
...
/////////////////////////////////////////////////////////////////////
COLORREF CBKDib::RGBQUAD2RGB (RGBQUAD c)
{
	return RGB(c.rgbRed,c.rgbGreen,c.rgbBlue);
}
/////////////////////////////////////////////////////////////////////
void CBKDib::SetGrayPalette()
{
...
/////////////////////////////////////////////////////////////////////
void CBKDib::BlendPalette(COLORREF cr,long perc)
{
	if ((hDib==NULL)||(m_nColors==0)) return;
	BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
	long i,r,g,b;
...
/////////////////////////////////////////////////////////////////////
long CBKDib::WriteBMP(LPSTR bmpFileName)
{                         
...
{ }
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CBKShadeButton, CButton)
	//{{AFX_MSG_MAP(CBKShadeButton)
	ON_WM_ERASEBKGND()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
...
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
// CBKShadeButton message handlers
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::PreSubclassWindow() 
{
	CButton::PreSubclassWindow();
	ModifyStyle(0, BS_OWNERDRAW);
}
/////////////////////////////////////////////////////////////////////////////
BOOL CBKShadeButton::OnEraseBkgnd(CDC* pDC) 
{
	return 1;	// doesn't erase the button background
}
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::SetShade(UINT shadeID,BYTE granularity,BYTE highlight,BYTE coloring,COLORREF color)
{
...
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::SetIcon(UINT nIcon, UINT nIconAlign)
{
...
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::SetTextAlign(UINT nTextAlign)
{
//	see DrawText() styles...
	switch (nTextAlign){
	case BS_RIGHT:
...
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::SetFlat(bool bFlag)
{
	m_flat=bFlag;	//set flat border mode
}
/////////////////////////////////////////////////////////////////////////////
COLORREF CBKShadeButton::SetTextColor(COLORREF new_color)
{
...
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::SetToolTipText(CString s)
{
...
/////////////////////////////////////////////////////////////////////////////
void CBKShadeButton::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
...
//
//---------------------------------------------------------
void CBKShadeButton::OnLButtonDblClk(UINT flags, CPoint point) 
{
...
//
//---------------------------------------------------------
void CBKShadeButton::OnLButtonDown(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: down\n", ::GetTickCount());
...
//
//---------------------------------------------------------
void CBKShadeButton::OnLButtonUp(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: up\n", ::GetTickCount());
...
//
//---------------------------------------------------------
void CBKShadeButton::OnMouseMove(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: Mouse\n", ::GetTickCount());
...
//
//---------------------------------------------------------
LRESULT CBKShadeButton::OnMouseLeave(WPARAM, LPARAM)
{
    ASSERT (m_tracking);
    //TRACE("* Mouse leave\n");
    m_tracking = false;
...
//
//---------------------------------------------------------
void CBKShadeButton::OnKillFocus(CWnd *new_wnd)
{
