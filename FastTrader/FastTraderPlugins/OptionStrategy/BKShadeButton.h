...
class CBKShadeButton : public CButton
{
// Construction
public:
	CBKShadeButton();
...
public:
	...
	virtual ~CBKShadeButton();
	// Generated message map functions
protected:
	CBKDib m_dNormal,m_dDown,m_dDisabled,m_dOver,m_dh,m_dv;
    bool m_tracking;
    bool m_button_down;
