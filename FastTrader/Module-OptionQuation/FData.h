...
public:
	...
	bool AppendHistoryTLineData(std::vector<TLineBase>& vecTimeLineData);
	bool AppendRealTimeTLineData();
	bool AppendHistoryKLineData_Min1(std::vector<KLineBase>& vecData);
	bool AppendRealTimeKLineData_Min1();
	bool AppendHistoryKLineData_Min5(std::vector<KLineBase>& vecData);
	bool AppendRealTimeKLineData_Min5();
	bool AppendHistoryKLineData_Min15(std::vector<KLineBase>& vecData);
	bool AppendRealTimeKLineData_Min15();
	bool AppendHistoryKLineData_Min30(std::vector<KLineBase>& vecData);
	bool AppendRealTimeKLineData_Min30();
	bool AppendHistoryKLineData_Min60(std::vector<KLineBase>& vecData);
	bool AppendRealTimeKLineData_Min60();
	bool AppendHistoryKLineData_Day(std::vector<KLineBase>& vecData);
	bool AppendRealTimeKLineData_Day();
	bool AppendHistoryKLineData_Week(std::vector<KLineBase>& vecData);
	bool AppendRealTimeKLineData_Week();
	bool AppendHistoryKLineData_Month(std::vector<KLineBase>& vecData);
