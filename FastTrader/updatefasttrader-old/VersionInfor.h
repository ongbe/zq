...
//methods:
  ...
  wxString                       GetValue(const wxString& sKeyName);
  wxString                       GetComments();
  wxString                       GetCompanyName();
  wxString                       GetFileDescription();
  wxString                       GetFileVersionAsString();
  wxString                       GetInternalName();
  wxString                       GetLegalCopyright();
  wxString                       GetLegalTrademarks();
  wxString                       GetOriginalFilename();
  wxString                       GetPrivateBuild();
  wxString                       GetProductName();
  wxString                       GetProductVersionAsString();
  wxString                       GetSpecialBuild();
