...
wxDialog(parent, wxID_ANY,LOADSTRING(ABOUTDLG_TITLE),wxDefaultPosition, wxSize(350,185))
{
    ...
    if(GlobalConfigManager::m_RunMode==2||GlobalConfigManager::m_RunMode==3)
        itemStaticText6 = new wxStaticText( this, wxID_STATIC, LOADSTRING(OIP_FASTTRADER_Option), wxDefaultPosition, wxDefaultSize, 0 );
    else 
        itemStaticText6 = new wxStaticText( this, wxID_STATIC, LOADSTRING(OIP_FASTTRADER), wxDefaultPosition, wxDefaultSize, 0 );
