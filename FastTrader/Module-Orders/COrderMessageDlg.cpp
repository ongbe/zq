...
void COrderMessageDlg::CreateGUIControls()
{
	...
	//
    wxStaticText* pStaticText = new wxStaticText(this, ID_ORDERMESSAGEDLG_WARNINGTEXT, 
			LOADSTRING(MSG_CANCELALL_WARNING), 
			wxPoint(20, dlgClientSize.y-30), wxDefaultSize);	
