...
extern UINT WM_XSPIN_KILL_FOCUS;
extern UINT WM_XSPIN_VK_ESCAPE;


class CXSpinCtrl : public CSpinButtonCtrl
{
// Construction
public:
	CXSpinCtrl(CWnd *pParent=NULL);
	virtual ~CXSpinCtrl();
