...
public:
	void Init();
	void SetFuture(string ExchangeName,string ContractName,string ContractDate, string InstrumentName);	//某只期货的名称
...
public:
	...
	void SetInstrumentName(unsigned long lValue);
