...
public:
	...
	void ClearMemoryMark(MAPsmark&  mapMarks);
//	void *m_pWnd;
...
protected:	
	...
	*/
	...
	MAPsmark*		  m_mapMarksCommon;

	vector<SKLine *> m_vecKLineDay; 
	bool  m_bSelDay;
	MAPsmark		  m_mapMarksDay;
	bool  m_bSelDay_Marks;

	vector<SKLine *> m_vecKLineWeek; 
	bool  m_bSelWeek;
	MAPsmark		  m_mapMarksWeek;
	bool  m_bSelWeek_Marks;

	vector<SKLine *> m_vecKLineMonth; 
	bool  m_bSelMonth;
	MAPsmark		  m_mapMarksMonth;
	bool  m_bSelMonth_Marks;

	vector<SKLine *> m_vecKLineMin1;
	bool  m_bSelMin1;
	MAPsmark		  m_mapMarksMin1;
	bool  m_bSelMin1_Marks;

	vector<SKLine *> m_vecKLineMin5; 
	bool  m_bSelMin5;
	MAPsmark		  m_mapMarksMin5;
	bool  m_bSelMin5_Marks;

	vector<SKLine *> m_vecKLineMin15; 
	bool  m_bSelMin15;
	MAPsmark		  m_mapMarksMin15;
	bool  m_bSelMin15_Marks;

	vector<SKLine *> m_vecKLineMin30; 
	bool  m_bSelMin30;
	MAPsmark		  m_mapMarksMin30;
	bool  m_bSelMin30_Marks;

	vector<SKLine *> m_vecKLineMin60;  
	bool  m_bSelMin60;
	MAPsmark		  m_mapMarksMin60;
	bool  m_bSelMin60_Marks;
...
public:
	...
	MAPsmark*		    GetMarksCommon(EnumPhrase enumPhrase);
	void				SetSelMinsValue_Marks(EnumPhrase enumPhrase);
	bool				GetSelMinsValue_Marks(EnumPhrase enumPhrase);
protected:
...
public://技术指标相关	
	bool CalcKTechIndex(vector<SKLine *>& m_vecKLine, string strTechIndexNameOrg, string strTechIndexName, STechCalcPara& sTCPara, CTechIndex*& pTechIndex, vector<int>* vecConfigDefault = NULL);
...
private:
	...
	void Calc(string strTechIndexName, vector<SKLine *>& m_vecKLine, STechCalcPara& sTCPara, vector<int>& vecConfig, CTechIndex*& pTechIndex);
