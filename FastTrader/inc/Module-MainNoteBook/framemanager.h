...
public:
    ...
    virtual void ShowHint(const wxRect& rect,wxAuiManagerDock dir=wxAUI_DOCK_NONE);
    virtual void HideHint();
	virtual wxAuiManagerDock GetDockDirection(){return m_hint_dir;}
public:
