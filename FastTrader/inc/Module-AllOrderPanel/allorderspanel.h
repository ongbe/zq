...
private:
	...
	void OnRspForQuoteInsert(wxCommandEvent& evt);
	void OnErrRtnForQuoteInsert(wxCommandEvent& evt);
	void OnRtnExecOrder(wxCommandEvent& evt);
	void OnRspExecOrderInsert(wxCommandEvent& evt);
	void OnErrRtnExecOrderInsert(wxCommandEvent& evt);
	void OnRspExecOrderAction(wxCommandEvent& evt);
	void OnErrRtnExecOrderAction(wxCommandEvent& evt);
    ...
    static int OrderInsertBackFunc1(const GUIModuleID GID,const AbstractBusinessData &data);	  //报单录入回报
    static int OrderInsertBackFunc2(const GUIModuleID GID,const AbstractBusinessData &data);	  //报单录入回报
	static int RspForQuoteInsertCallBackFunc(const GUIModuleID GID,const AbstractBusinessData& data);	// 期权询价回报
	static int ErrRtnForQuoteInsertCallBackFunc(const GUIModuleID GID,const AbstractBusinessData& data);	// 期权询价错误回报
	static int RtnExecOrderCallBackFunc(const GUIModuleID GID,const AbstractBusinessData& data);	// 执行宣告通知
	static int RspExecOrderInsertCallBackFunc(const GUIModuleID GID,const AbstractBusinessData& data);	// 执行宣告响应
	static int ErrRtnExecOrderInsertCallBackFunc(const GUIModuleID GID,const AbstractBusinessData& data);	// 执行宣告错误回报
	static int RspExecOrderActionCallBackFunc(const GUIModuleID GID,const AbstractBusinessData& data);	// 执行宣告操作响应
	static int ErrRtnExecOrderActionCallBackFunc(const GUIModuleID GID,const AbstractBusinessData& data);	// 执行宣告操作错误回报
    ...
    void OnRspQryDepthMarketData(wxCommandEvent& evt);
    //保证金率回报
    ...
    //组合报单查询行情回报
    static int QryDepthMarketDataCallBackFunc(const GUIModuleID GID,const AbstractBusinessData &data);
