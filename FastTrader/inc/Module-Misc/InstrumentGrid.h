...
{
public:
	InstrumentGridTable(vector<SimpleInstrumentInfo>& instruments,vector<string>& headers);
...
private:
	...
	vector<SimpleInstrumentInfo> m_Instruments;
};
...
public:
		...
		~InstrumentGrid();
		void AddInstrumentGridTable(vector<SimpleInstrumentInfo>& instruments,vector<string>& headers);
