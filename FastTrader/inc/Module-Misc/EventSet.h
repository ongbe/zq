...
BEGIN_DECLARE_EVENT_TYPES()	
	...
	// 下单板有关的公共指令事件
	DECLARE_EVENT_TYPE(wxEVT_GRID_INSTRUMENTID_CHANGED, 2701)			// 表格上的合约代码改变事件, GetInt()为EvtParamID，GetExtraLong()为发送者GID
	...
	DECLARE_EVENT_TYPE(wxEVT_INSTRUMENT_LIST_COMMISSIONRATE_UPDATE,2801)        //期货合约手续费率更新
	DECLARE_EVENT_TYPE(wxEVT_INSTRUMENT_LIST_MARGINRATE_UPDATE,2802)            //期货合约保证金率更新
	DECLARE_EVENT_TYPE(wxEVT_INSTRUMENT_LIST_OPTIONINSTRCOMM_UPDATE,2803)       //期权合约手续费率更新
	DECLARE_EVENT_TYPE(wxEVT_INSTRUMENT_LIST_OPTIONINSTRTRADECOST_UPDATE,2804)  //期权合约交易成本更新
	//报价表事件
...
//	DECLARE_EVENT_TYPE(wxEVT_QUOT_GET_GROUP, 2718)						//响应外部指令：选择指定合约组
    ...
    DECLARE_EVENT_TYPE(wxEVT_RspQryPositionDetailCombLast,3004)

    DECLARE_EVENT_TYPE(wxEVT_RspQryCommissionRate, 3010)
    DECLARE_EVENT_TYPE(wxEVT_RspQryMarginRate, 3011)
    DECLARE_EVENT_TYPE(wxEVT_RspQryDepthMarketData, 3012)
    ...
    DECLARE_EVENT_TYPE(wxEVT_RspOrderInsert, 3023)
	...
	DECLARE_EVENT_TYPE(wxEVT_LOCALPLDETAIL_STATUSCHANGED, 3037)
	DECLARE_EVENT_TYPE(wxEVT_SERVCOND_OVERBOUNDFAIL, 3038)
	DECLARE_EVENT_TYPE(wxEVT_PLSERVCOND_OVERBOUNDFAIL, 3039)

	DECLARE_EVENT_TYPE(wxEVT_MAIN_NOTICESOUND, 3040)

	DECLARE_EVENT_TYPE(wxEVT_PLDETAILDLG_PRECLOSE, 3041)
    
	DECLARE_EVENT_TYPE(wxEVT_MASSAGE_NOTICE, 3042)
	...
	DECLARE_EVENT_TYPE(wxEVT_MA_PLAT_DELETE,3061)

    DECLARE_EVENT_TYPE(wxEVT_MA_MENU_LOGIN,3070)
    DECLARE_EVENT_TYPE(wxEVT_MA_MENU_LOGOUT,3071)
    DECLARE_EVENT_TYPE(wxEVT_MA_MENU_SETQUOT,3072)
    DECLARE_EVENT_TYPE(wxEVT_MA_MENU_SETFIRSTACCOUNT,3073)

    DECLARE_EVENT_TYPE(wxEVT_MENU_OPTIONUI_DarkBackground,3090)
    DECLARE_EVENT_TYPE(wxEVT_MENU_OPTIONUI_LightBackground,3091)

    DECLARE_EVENT_TYPE(wxEVT_ALL_ORDER_RspForQuoteInsert,3092)
    DECLARE_EVENT_TYPE(wxEVT_ALL_ORDER_ErrRtnForQuoteInsert,3093)
	DECLARE_EVENT_TYPE(wxEVT_ORDER_INSERT_PANEL_SUBSFORQUOTE,3094)
	DECLARE_EVENT_TYPE(wxEVT_ORDER_INSERT_PANEL_UNSUBSFORQUOTE,3095)
	DECLARE_EVENT_TYPE(wxEVT_ORDER_INSERT_PANEL_FORQUOTERSP,3096)
    DECLARE_EVENT_TYPE(wxEVT_ALL_ORDER_RtnExecOrder,3097)
    DECLARE_EVENT_TYPE(wxEVT_ALL_ORDER_RspExecOrderInsert,3098)
    DECLARE_EVENT_TYPE(wxEVT_ALL_ORDER_ErrRtnExecOrderInsert,3099)
    DECLARE_EVENT_TYPE(wxEVT_ORDER_INSERT_RspQryExecOrder,3100)
    DECLARE_EVENT_TYPE(wxEVT_ALL_ORDER_RspExecOrderAction,3101)
    DECLARE_EVENT_TYPE(wxEVT_ALL_ORDER_ErrRtnExecOrderAction,3102)
