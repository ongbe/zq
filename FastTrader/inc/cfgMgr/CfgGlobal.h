...
typedef struct tagOrderCfg
{
	...
	zq_bool		bReachUpperLimitDlg;				// 条件单达到上限 是否 弹框
	zq_bool		bReachUpperLimitSound;				// 条件单达到上限 是否 发声
	zq_bool		bConventSuccessDlg;					// 条件单转换成功 是否 弹框
	zq_bool		bConventSuccessSound;				// 条件单转换成功 是否 发声
	zq_bool		bConventFailDlg;					// 条件单转换失败 是否 弹框
	zq_bool		bConventFailSound;					// 条件单转换失败 是否 发声
