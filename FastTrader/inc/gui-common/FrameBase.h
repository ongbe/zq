...
public:
    ...
    enum
    {
        ...
        ID_CONFIG_OPTIONUI_DarkBackground,              //期权UI：深色背景
        ID_CONFIG_OPTIONUI_LightBackground,             //期权UI：浅色背景
		ID_OPTIONORDER_FORQUOTEINSERT,					//期权询价
		ID_OPTIONORDER_EXECORDER,						//期权执行与查询
		ID_OPTIONORDER_SUBSUNSUBSFORQUOTE,				//期权询价订阅与退订
