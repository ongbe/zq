...
private:
	...
	void CopyPositionDetailField( PlatformStru_PositionDetail&data, const PlatformStru_Position& positionField );
	void CopyPositionCombField( PlatformStru_PositionCombDetail& New, const CThostFtdcInvestorPositionCombineDetailField& Old);
