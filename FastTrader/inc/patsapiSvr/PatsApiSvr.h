...
public:
    ...
    int GetPositionDetails3(const std::string& strInstrument,
                              ...
                              long& lastseq);
    int GetPositionCombs2(const std::string& strInstrument,std::vector<PlatformStru_PositionComb>& outData);
...
public:
	...
	//获取组合持仓详情
	int GetPositionCombInfo(long lFTID, PlatformStru_PositionCombDetail& outData);
	//int GetPositionCombInfo(PositionCombKey key, PlatformStru_PositionCombDetail& outData);
