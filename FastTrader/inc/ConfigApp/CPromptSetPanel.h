...
private:
	...
	wxCheckBox* m_chkReachUpperLimit;
	wxOwnerDrawnComboBox* m_cmbReachUpperLimitSound;
	wxCheckBox* m_chkConventSuccess;
	wxOwnerDrawnComboBox* m_cmbConventSuccessSound;
	wxCheckBox* m_chkConventFailed;
	wxOwnerDrawnComboBox* m_cmbConventFailedSound;
