...
private:
	...
	bool GetOrderInfoByRowNo(int RowNo, DWORD& RowID, CLocalOrderService::BATCHSUBORDER& tBatchItem);
	int LoadOneOrderList(const CLocalOrderService::BATCHSUBORDER& tBatchOrder);
...
private:
    ...
    std::map<int, CLocalOrderService::BATCHSUBORDER> m_MapOrderKey_OrderInfo;    //BatchNum到BATCHSUBORDER的对应Map
