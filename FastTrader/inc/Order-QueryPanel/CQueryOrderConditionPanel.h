...
private:
	...
	static int CallBack_OrderInsert1(const GUIModuleID GID,const AbstractBusinessData &data);		//报单录入回报
	static int CallBack_OrderInsert2(const GUIModuleID GID,const AbstractBusinessData &data);		//报单录入回报
