...
CConfigAppDlg::CConfigAppDlg(wxWindow *parent, const int defaultItemId):
...
void CConfigAppDlg::InitializeTree()
{
	...
	//}
	if ( DEFAULT_SVR()&&DEFAULT_SVR()->IsModuleValid( GID_QUERY_ORDER_PLDETAIL ))
	{
		wxTreeItemId pldetailOrderId = m_treeCtrl->AppendItem( tableSetId,	 LOADSTRING(IDT_ORDERPLDETAIL),-1,-1,new wxTreeItemIntData(ID_ITEM_ORDER_PLDETAIL ));
		m_panelMap[ID_ITEM_ORDER_PLDETAIL] = NULL;
		m_treeItemMap[ID_ITEM_ORDER_PLDETAIL] = pldetailOrderId;
	}

	if ( DEFAULT_SVR()&&DEFAULT_SVR()->IsModuleValid( GID_QUERY_ORDER_POSIPL ))
	{
		wxTreeItemId pldId = m_treeCtrl->AppendItem( tableSetId,	 LOADSTRING(ORDERTYPE_STOP),-1,-1,new wxTreeItemIntData(ID_ITEM_ORDER_POSIPL ));
		m_panelMap[ID_ITEM_ORDER_POSIPL] = NULL;
		m_treeItemMap[ID_ITEM_ORDER_POSIPL] = pldId;
	}
...
{   
	...
	if ( itemId.IsOk() )
	{
		...
		else if( strText == ID_ITEM_SELFGROUP )
		{
			...
			{
				m_panelMap[ID_ITEM_SELFGROUP] = new CSelfGroupSetPanel( DEFAULT_SVR(), this, wxID_ANY,wxPoint(172,8),wxSize(487,337));
			}
		...
		else if( strText == ID_ITEM_GROUPSET )
		{
			...
			{
				m_panelMap[ID_ITEM_GROUPSET] = new CGroupSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_VARIETYINFOSET )
		{
			...
			{
				m_panelMap[ID_ITEM_VARIETYINFOSET] = new CVarietyInfoSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_SHOW )
		{
			...
			{
				m_panelMap[ID_ITEM_SHOW] = new CShowSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_FONTANDCOLOR )
		{
			...
			{
				m_panelMap[ID_ITEM_FONTANDCOLOR] = new CFontAndColorSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_GENERALSET )			    
		{
			...
			{
				m_panelMap[ID_ITEM_GENERALSET] = new CGeneralSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_AUTOOPENCLOSESET )
		{
			...
			{
				m_panelMap[ID_ITEM_AUTOOPENCLOSESET] = new CAutoOpenCloseSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_KEYBOARDOPENODER )
		{
			...
			{
				m_panelMap[ID_ITEM_KEYBOARDOPENODER] = new CKeyboardOpenOrderSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_MOUSEOPENORDER)
		{
			...
			{
				m_panelMap[ID_ITEM_MOUSEOPENORDER] = new CMouseOpenOrderSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_ADVANCEDSET )                
		{
			...
			{
				m_panelMap[ID_ITEM_ADVANCEDSET] = new CAdvancedSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_GENERALCANCELORDER )
		{
			...
			{
				m_panelMap[ID_ITEM_GENERALCANCELORDER] = new CGeneralCancelOrderSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_RISKMANAGER )
		{
			...
			{
				m_panelMap[ID_ITEM_RISKMANAGER] = new CRiskManagerSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_PROMPT )
		{
			...
			{
				m_panelMap[ID_ITEM_PROMPT] = new CPromptSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337) );
			}
		...
		else if( strText == ID_ITEM_QUOTETABLE )
		{
			...
			{
				m_panelMap[ID_ITEM_QUOTETABLE] = new CTableSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_QUOT_TABLE );
			}
		...
		else if( strText == ID_ITEM_TRADERECORD )
		{
			...
			{
				m_panelMap[ID_ITEM_TRADERECORD] = new CTableSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_THRADE_RECORD );
			}
		...
		else if( strText == ID_ITEM_TRADESTATISTIC )
		{
			...
			{
				m_panelMap[ID_ITEM_TRADESTATISTIC] = new CTableSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_THRADE_STATISTICS );
			}
		...
		else if( strText == ID_ITEM_POSITION )
		{
			...
			{
				m_panelMap[ID_ITEM_POSITION] =  new CTableSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_POSITION );
			}
		...
		else if ( strText == ID_ITEM_COMBO_POSITION)
		{
			...
			{
				m_panelMap[ID_ITEM_COMBO_POSITION] = new CTableSetPanel( this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_POSITIONCOMB );
			}
		...
		else if( strText == ID_ITEM_POSITIONDETAIL )
		{
			...
			{
				m_panelMap[ID_ITEM_POSITIONDETAIL] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_POSITIONDETAIL );
			}
		...
		else if( strText == ID_ITEM_INSTRUMENTLIST )
		{
			...
			{
				m_panelMap[ID_ITEM_INSTRUMENTLIST] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_INSTRUMENT );
			}
		...
		else if( strText == ID_ITEM_ALLORDER )
		{
			...
			{
				m_panelMap[ID_ITEM_ALLORDER] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_ALL_ORDER );
			}
		...
		else if( strText == ID_ITEM_WAITTRADE )
		{
			...
			{
				m_panelMap[ID_ITEM_WAITTRADE] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_OPEN_ORDER );
			}
		...
		else if( strText == ID_ITEM_PARKEDORDER )
		{
			...
			{
				m_panelMap[ID_ITEM_PARKEDORDER] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_QUERY_ORDER_PARKED );
			}
		...
		else if( strText == ID_ITEM_ACCOUNT )
		{
			...
			{
				m_panelMap[ID_ITEM_ACCOUNT] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_ACCOUNT );
			}
		...
		else if( strText == ID_ITEM_QUERYORDERBATCH )
		{
			...
			{
				m_panelMap[ID_ITEM_QUERYORDERBATCH] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_QUERY_ORDER_BATCH );
			}
		...
		else if( strText == ID_ITEM_QUERYORDERCONDITION )
		{
			...
			{
				m_panelMap[ID_ITEM_QUERYORDERCONDITION] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_QUERY_ORDER_CONDITION );
			}
		...
		else if( strText == ID_ITEM_QUERYORDERPOSITION )
		{
			...
			{
				m_panelMap[ID_ITEM_QUERYORDERPOSITION] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_QUERY_ORDER_POSITION);
			}
		...
		else if( strText == ID_ITEM_ORDER_INSERT )
		{
			...
			{
				m_panelMap[ID_ITEM_ORDER_INSERT] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_ORDER_INSERT_PANEL, false);
			}
			SwitchShow ( m_panelMap[ID_ITEM_ORDER_INSERT] );
		}
		else if( strText == ID_ITEM_ORDER_PLDETAIL )
		{
			if( m_panelMap[ID_ITEM_ORDER_PLDETAIL] ==NULL)
			{
				m_panelMap[ID_ITEM_ORDER_PLDETAIL] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_QUERY_ORDER_PLDETAIL);
			}
			SwitchShow ( m_panelMap[ID_ITEM_ORDER_PLDETAIL] );
		}
		else if( strText == ID_ITEM_ORDER_POSIPL )
		{
			if( m_panelMap[ID_ITEM_ORDER_POSIPL] ==NULL)
			{
				m_panelMap[ID_ITEM_ORDER_POSIPL] = new CTableSetPanel(this,wxID_ANY,wxPoint(172,8),wxSize(487,337), GID_QUERY_ORDER_POSIPL);
			}
			SwitchShow ( m_panelMap[ID_ITEM_ORDER_POSIPL] );
		}
	}
...
void CConfigAppDlg::OnOK( wxCommandEvent& event)
{
	...
	if( NULL != m_panelMap[ID_ITEM_ORDER_PLDETAIL] )
	{
		if( ((CTableSetPanel*)m_panelMap[ID_ITEM_ORDER_PLDETAIL])->WriteCfg())
		{
			vecMsg.push_back(MSG_LIST_ORDER_PLDETAIL);
		}
	}

	if( NULL != m_panelMap[ID_ITEM_ORDER_POSIPL] )
	{
		if( ((CTableSetPanel*)m_panelMap[ID_ITEM_ORDER_POSIPL])->WriteCfg())
		{
			vecMsg.push_back(MSG_LIST_ORDER_POSIPL);
		}
	}
