...
protected:
	BOOL InitAppPipe(CString strAppPipe);
	void ReleaseAppPipe();
	BOOL Login(CString& strMasterPipe); 
	void Hello(CString& strMasterPipe); 
	void HeartBeat(CString& strMasterPipe); 
	void AutoHeartBeat(); 
