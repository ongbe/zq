...
#define CHECK_TRADE_STATUS() \
	...
	***********************************************************/
	...
	int CPlatFormService::LoginTrade(const std::string& InvestorID, const std::string& InvestorPW, const std::string& InvestorNewPwd)
	{
		...
		char FrontAddr[256];
		strcpy(FrontAddr,m_PlatformParam.TradeFrontAddrs[0].c_str());
		strcat(FrontAddr,";");
		strcat(FrontAddr,m_PlatformParam.QuotFrontAddrs[0].c_str());
	...
	CPlatFormService::CPlatFormService(CPatsApiSvr& rServiceProxy)
