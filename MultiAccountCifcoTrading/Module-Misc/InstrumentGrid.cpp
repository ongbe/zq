...
InstrumentGridTable::InstrumentGridTable(vector<InstrumentInfo>& instruments,vector<string>& headers):
...
void InstrumentGrid::AddInstrumentGridTable(vector<InstrumentInfo>& instruments,vector<string>& headers)
{
