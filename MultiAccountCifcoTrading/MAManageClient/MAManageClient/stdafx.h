...
const LPCTSTR lpszChangePermissionTypeWarning = _T("前台/后台权限只能选择一项，点击[保存]后\n会完全覆盖之前数据，请确认！");
const LPCTSTR lpszEmptyServrAddr = _T("请输入服务器地址！");
const LPCTSTR lpszEmptyServrPort = _T("请输入端口号！");
const LPCTSTR lpszEmptyServrGroup = _T("请输入服务器组！");
const LPCTSTR lpszSelectBrokerFirst = _T("请先选择经纪公司！");
const LPCTSTR lpszSelectServerGroupFirst = _T("请选择一个服务器组！");
const LPCTSTR lpszSelectServerAddrFirst = _T("请选择一条服务器地址！");
