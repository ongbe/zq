...
CRITICAL_SECTION CEventParam::m_CS;
DWORD CEventParam::m_BaseID=1;
map<DWORD,Stru_EventParam> CEventParam::m_mapEvtParam;


//程序开始时Init
void CEventParam::Init(void)
{
...
bool CEventParam::CreateEventParam(DWORD& RltEventParamID,DWORD* pEventID,string* pEventString,const void* pEventPtr,int EventPtrLen,int EventUserInt)
{
    EnterCriticalSection(&m_CS);
...
bool CEventParam::DeleteEventParam(DWORD EventParamID)
{
    bool brlt=false;
...
bool CEventParam::GetEventParam(DWORD EventParamID,DWORD* pRltEventID,string* pRltEventString,void* pRltEventPtr,int* pRltEventPtrLen,int MaxRltEventPtrLen,int* pRltEventUserInt)
{
    bool brlt=false;
