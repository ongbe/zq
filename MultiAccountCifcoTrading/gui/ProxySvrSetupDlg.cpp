...
m_SelRow(0)
{
	...
	new wxButton( this, wxID_OK, LOADSTRING(SOCKS_OK),wxPoint(385,385), wxSize(70,20), 0 );
	new wxButton( this, wxID_CANCEL, LOADSTRING(SOCKS_CANCEL),wxPoint(480,385), wxSize(70,20), 0 );
}
