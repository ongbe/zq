...
#define LAYOUT_FILENAME                     _("layout.txt")
#define SYSCFG_FILENAME                     _("syscfg.xml")
#define USERCFG_FILENAME                     _("usercfg.xml")
...
caption=((MainFrame*)GETTOPWINDOW())->GetPanelCaption(gid,0);\
...
if(file.IsOpened()){
#define END_DO_EXPORT() file.Close();}}
