...
public:
	...
	static BOOL GetHoldingVolume(string strCode, BOOL bIsBuy, BOOL bIsHedge, int& nSumVolume, int& nSumTodayVolume, string strAccount);
	static BOOL GetAskCloseVolume(string strCode, BOOL bIsBuy, BOOL bIsHedge, int& nAskVolume, int& nAskTodayVolume, string strAccount);
	static BOOL GetPreVolume(string strCode, BOOL bIsBuy, BOOL bIsHedge, int& nAskVolume, int& nAskTodayVolume, string strAccount);//可平数量
...
protected:
	...
	//BOOL InsertOrder(wxString& strInstrumentID, 
	//		BOOL bDirection, int nOCMode, double fPrice, int nVolume, BOOL bIsHedge, 
	//		BOOL bIsMarketPrice, BOOL bSimulate, BOOL bIsParketOrder);
...
//	DataRspOrderInsert	m_tRspOrderReqs[conMaxRspOrderReqNum];
